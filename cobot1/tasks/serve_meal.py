"""트레이 홀더 원위치 파지 → 식전 무게 → 사용자 인계 → 원위치 복귀."""
    ...
    def _execute(self) -> None:
        ...
        def _weigh_before() -> None:
            ...
            motion._ctx.node.get_logger().info(
                f"[{task}] 식전 무게 세션 저장 완료 (식사 가져가기 후 섭취율 계산 예정)"
            )
        ...
        steps = [
            ...
            ("tray_weigh_before", _weigh_before),
