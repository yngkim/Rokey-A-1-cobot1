...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'measure_tray_weight = cobot1.measure_tray_weight:main',
            'clean_floor = cobot1.clean_floor:main',
            'serve_meal = cobot1.serve_meal:main',
            'return_tray = cobot1.return_tray:main',
            'calibrate_tray_tare = cobot1.calibrate_tray_tare:main',
